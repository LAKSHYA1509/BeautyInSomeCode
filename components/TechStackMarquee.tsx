  ...
  return (
    <section className="py-16 bg-muted/30 overflow-hidden border-y border-white/5">
      <div className="mb-10 text-center">
        <p className="text-2xl text-white font-mono text-accent tracking-[0.2em] uppercase">Core Expertise</p>
      </div>
      ...
      <Marquee speed={40}>
        <div className="flex gap-8 px-4">
          {COMPETENCIES.map((skill, idx) => (
            ...
            >
              <skill.icon className="w-5 h-5 text-accent text-yellow-500" />
