          ...
          {CERTIFICATIONS.map((cert, index) => (
            ...
            >
              <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                <cert.icon className="w-24 h-24 text-yellow-500 rotate-12" />
              </div>

              <div className="relative z-10">
                <div className="w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center mb-4 text-yellow-500">
